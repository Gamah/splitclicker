...
public sealed class SkafinityPlayer : Component
{
	...
	/// <summary>Randomize the vibe knobs and store + restart once. By default skips the
	/// per-instrument volumes and keeps the genre; pass <paramref name="includeVolumes"/> /
	/// <paramref name="includeGenre"/> to randomize those too (full shuffle).</summary>
